    ...
    return(
      <div className="cf-settings-base container">
        ...
        <div style={pointerReady} className="row justify-content-between">
          <div onClick={ () => { this.props.history.push('/help/embed') } } className="col-3 cf-install-tile">
            <h3 style={overideStyle} className="text-center">Universal Install</h3>
          </div>
          <div onClick={ () => { this.props.history.push('/help/embedwp') } } style={pointerReady} className="col-3 cf-install-tile">
